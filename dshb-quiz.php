        ...
        <div class="dashboard -home-9 js-dashboard-home-9">
          <div class="dashboard__sidebar scroll-bar-1">
            ...
            <div class="sidebar -dashboard">
              ...
              <div class="sidebar__item ">
                <a href="dashboard.php" class="d-flex items-center text-17 lh-1 fw-500 ">
                  <i class="text-20 icon-discovery mr-15"></i>
                  Dashboard
                </a>
              </div>
              ...
              <div class="sidebar__item -is-active -dark-bg-dark-2">
                <a href="dshb-listing.php" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
                  <i class="text-20 icon-list mr-15"></i>
                  Create Course
                </a>
              </div>
            ...
            <div class="dashboard__content bg-light-4">
              <div class="row pb-50 mb-10">
                <div class="col-auto">
                  ...
                  <h1 class="text-30 lh-12 fw-700">Quiz</h1>
                ...
                <div class="col-xl-9">
                  <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                    <div class="d-flex items-center py-20 px-30 border-bottom-light">
                      <h2 class="text-17 lh-1 fw-500">Quiz</h2>
                    </div>
                    ...
                    <div class="py-30 px-30">
                      <div class="border-light overflow-hidden rounded-8">
                        ...
                        <div class="py-40 px-40 bg-dark-5">
                          <div class="d-flex justify-between">
                            <h4 class="text-18 lh-1 fw-500 text-white">Question 1</h4>
                          ...
                          <div class="text-20 lh-1 text-white mt-15">You are watching the TV news and see this appear on the screen:</div>
                        </div>
                        ...
                        <div class="px-40 py-40">
                          ...
                          <div class="form-radio d-flex items-center ">
                            ...
                            <div class="fw-500 ml-12">a. A tweet</div>
                          </div>
                          ...
                          <div class="form-radio d-flex items-center mt-20">
                            ...
                            <div class="fw-500 ml-12">b. A hashtag</div>
                          </div>
                          ...
                          <div class="form-radio d-flex items-center mt-20">
                            ...
                            <div class="fw-500 ml-12">c. A tag</div>
                          </div>

                        </div>
                      </div>

                      <div class="border-light overflow-hidden rounded-8 mt-30">

                        <div class="py-40 px-40 bg-dark-5">
                          <div class="d-flex justify-between">
                            <h4 class="text-18 lh-1 fw-500 text-white">Question 2</h4>
                            <div class="d-flex x-gap-50">
                              <div class="d-flex items-center text-white">
                                <div class="icon-flag mr-10"></div>
                                <div>Flag Question</div>
                          ...
                          <div class="text-20 lh-1 text-white mt-15">Complete the sentences:</div>
                        </div>


                        <form class="contact-form px-40 py-40">
                          <div class="d-flex items-center">
                            <div>If I want to send short messages of under 140 characters, I use</div>

                            <div class="col-auto ml-12">
                          ...
                          <div class="d-flex items-center mt-20">
                            <div>If I want to do a videochat on my iPhone I can use</div>
                          ...
                          <div class="mt-40">
                            <div class="d-flex x-gap-20 y-gap-10">

                              <div><button class="button -light-3 -dark-button-dark-2 -dark-text-white px-25 py-15 rounded-8">Twitter</button></div>

                              <div><button class="button -light-3 -dark-button-dark-2 -dark-text-white px-25 py-15 rounded-8">Instagram</button></div>

                              <div><button class="button -light-3 -dark-button-dark-2 -dark-text-white px-25 py-15 rounded-8">Facetime</button></div>

                              <div><button class="button -light-3 -dark-button-dark-2 -dark-text-white px-25 py-15 rounded-8">Pinterest </button></div>

                              <div><button class="button -light-3 -dark-button-dark-2 -dark-text-white px-25 py-15 rounded-8">Youtube</button></div>
                      ...
                      <div class="border-light overflow-hidden rounded-8 mt-30">
                        ...
                        <div class="py-40 px-40 bg-dark-5">
                          <div class="d-flex justify-between">
                            <h4 class="text-18 lh-1 fw-500 text-white">Question 3</h4>
                            <div class="d-flex x-gap-50">
                              <div class="d-flex items-center text-white">
                                <div class="icon-flag mr-10"></div>
                                <div>Flag Question</div>
                          ...
                          <div class="text-20 lh-1 text-white mt-15">A short message on Twitter is called a ?????</div>
                        </div>
                      ...
                      <div class="border-light overflow-hidden rounded-8 mt-30">
                        ...
                        <div class="py-40 px-40 bg-dark-5">
                          <div class="d-flex justify-between">
                            <h4 class="text-18 lh-1 fw-500 text-white">Question 4</h4>
                            <div class="d-flex x-gap-50">
                              <div class="d-flex items-center text-white">
                                <div class="icon-flag mr-10"></div>
                                <div>Flag Question</div>
                          ...
                          <div class="text-20 lh-1 text-white mt-15">Match the icons to their sites.</div>
                        </div>
                      ...
                      <div class="border-light overflow-hidden rounded-8 mt-30">
                        ...
                        <div class="py-40 px-40 bg-dark-5">
                          <div class="d-flex justify-between">
                            <h4 class="text-18 lh-1 fw-500 text-white">Question 5</h4>
                            <div class="d-flex x-gap-50">
                              <div class="d-flex items-center text-white">
                                <div class="icon-flag mr-10"></div>
                                <div>Flag Question</div>
                          ...
                          <div class="text-20 lh-1 text-white mt-15">Facebook was founded in 2005.</div>
                        </div>


                        <div class="px-40 py-40">
                          <div class="mb-20">Select one:</div>
                          ...
                          <div class="form-radio d-flex items-center ">
                            ...
                            <div class="fw-500 ml-12">True</div>
                          </div>
                          ...
                          <div class="form-radio d-flex items-center mt-20">
                            ...
                            <div class="fw-500 ml-12">False</div>
                          </div>

                          <a href="#" class="d-block fw-500 text-purple-1 underline mt-20">Clear my choice</a>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-between items-center mt-40">
                        ...
                        <div class="dropdown js-dropdown js-category-active">
                          <div class="dropdown__button d-flex items-center text-14 bg-white -dark-bg-dark-2 -dark-border-white-10 border-light rounded-8 px-20 py-10 " data-el-toggle=".js-category-toggle" data-el-toggle-active=".js-category-active">
