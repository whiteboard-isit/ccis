...
<head>
  ...
  <title>Academic Programs Accreditation</title>
</head>
            ...
            <div class="row justify-center text-center">
              <div class="col-auto">
                <div data-anim="slide-up delay-1">
                  ...
                  <h1 class="page-header__title">Academic Programs Accreditation</h1>
          ...
          <div class="row y-gap-50 justify-between items-center">
            <div class="col-lg-6 pr-50 sm:pr-15">
              <div class="composition -type-8">
                <div class="-el-1"><img src="img/Services/1.png" alt="image"></div>
                <div class="-el-2"><img src="img/Services/2.png" alt="image"></div>
                <div class="-el-3"><img src="img/Services/3.png" alt="image"></div>
              </div>
            </div>

            <div class="col-lg-5">
              <h2 class="text-30 lh-16">Designing and reviewing study plans </h2>
              <p class="text-dark-1 mt-30">for academic programs in computer majors according to the recommendations of the ACM / IEEE and the requirements of the Saudi Arabia Qualifications Framework (SAQF) and to the latest developments in the field and the needs of the market.</p>
              <p class="pr-50 lg:pr-0 mt-25">Provide support and training to accompany educational institutions in all stages of preparation and application for national and international academic accreditation for their academic programs in various computer disciplines.</p>
              <div class="d-inline-block">
                <a href="contact-1.php" class="button -md -purple-1 text-white mt-30">Get Started</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row y-gap-20 justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text ">Academic Programs Accreditation</p>
          ...
          <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Alignment with Standards and Frameworks</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Comprehensive Support and Training</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Application and Evaluation Process</div>
              </div>
            </div>
          ...
          <div class="row justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <h2 class="sectionTitle__title text-white">Partner with us to improve your business!</h2>

                <p class="sectionTitle__text text-white">
                  Implementing Academic Programs Accreditation with a focus on activating partnerships and providing training in information technology can bring about several benefits</p>
          ...
          <div data-anim-wrap class="row y-gap-30 justify-between pt-60 lg:pt-50">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-3 col-md-6">
              <div class="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div class="coursesCard__content mt-30">
                  <h5 class="coursesCard__title text-18 lh-1 fw-500">Knowledge Transfer and Skill Enhancement</h5>
                  <p class="coursesCard__text text-14 mt-10">Facilitating the exchange of knowledge and expertise in the latest information technology fields enhances skills, empowering individuals and organizations.</p>
                </div>
              </div>
            </div>
            ...
            <div data-anim-child="slide-up delay-2" class="col-lg-3 col-md-6">
              <div class="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div class="coursesCard__content mt-30">
                  <h5 class="coursesCard__title text-18 lh-1 fw-500">Strategic Partnerships and Networking Opportunities</h5>
                  <p class="coursesCard__text text-14 mt-10">Establishing partnerships with diverse entities creates strategic advantages, fostering collaboration, and providing valuable networking opportunities for mutual growth.</p>
                </div>
              </div>
            </div>
            ...
            <div data-anim-child="slide-up delay-3" class="col-lg-3 col-md-6">
              <div class="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div class="coursesCard__content mt-30">
                  <h5 class="coursesCard__title text-18 lh-1 fw-500">Enhanced Institutional Reputation</h5>
                  <p class="coursesCard__text text-14 mt-10">Delivering high-quality consulting and training services elevates the reputation of King Saud University and its King Abdullah Institute, garnering positive recognition within academic and professional circles.</p>
                </div>
              </div>
            </div>
            ...
            <div data-anim-child="slide-up delay-4" class="col-lg-3 col-md-6">
              <div class="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div class="coursesCard__content mt-30">
                  <h5 class="coursesCard__title text-18 lh-1 fw-500">Contribution to Economic and Social Development</h5>
                  <p class="coursesCard__text text-14 mt-10">Addressing the needs of public and private entities through tailored consulting services actively contributes to regional economic and social development, fostering innovation and a skilled workforce.</p>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 class="text-45 md:text-30 lh-12"> Start with the <span class="text-purple-1">Academic Programs Accreditation</span></h3>
              <p class="mt-20">Partner with CCIS</p>
              <div class="d-inline-block mt-30">
                <a href="contact-1.php" class="button -md -dark-1 text-white">Contact Us Now!</a>
              </div>
            </div>
            ...
            <div class="col-lg-6 lg:order-1">
              <div class="composition -type-3">
                  ...
                  <div class="bg-dark-1 py-50 px-30 rounded-8">
                    <div class="y-gap-20 pt-25">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="fw-500 text-white">Conduct a Needs Assessment</div>
                      </div>
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="fw-500 text-white">Develop a Basic Service Offering</div>
                      </div>
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="fw-500 text-white">Reach Out to Potential Partners</div>
                      </div>
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="fw-500 text-white">Promote Initial Service Offerings</div>
                      </div>
                ...
                <div class="-el-2">
                  <img class="w-1/1" src="img/Services/4.png" alt="image">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-center text-center mb-50">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <h2 class="sectionTitle__title ">Our Partners</h2>
