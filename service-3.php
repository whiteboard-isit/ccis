...
<head>
  ...
  <title>Research and Studies</title>
</head>
            ...
            <div class="row justify-center text-center">
              <div class="col-auto">
                <div data-anim="slide-up delay-1">
                  ...
                  <h1 class="page-header__title">Research and Studies</h1>
      ...
      <section class="layout-pt-md layout-pb-md">
        <div data-anim-wrap class="container">
          <div class="row y-gap-50 justify-between items-center">
            ...
            <div class="col-lg-5">
              <h2 class="text-30 lh-16">Provide Research and Studies </h2>
              <p class="text-dark-1 mt-30">Participation in research projects in partnership with various entities from the private and public sectors</p>
              <p class="pr-50 lg:pr-0 mt-25">Provide support in establishing and developing research activities in the areas of the beneficiaries to ensure optimal use of the latest relevant technologies.</p>
          ...
          <div class="row y-gap-20 justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text ">Research and Studies</p>
          ...
          <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Identify Research Opportunities and Partnerships</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Strategic Planning and Proposal Development</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Implementation and Support</div>
              </div>
            </div>
            ...
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text text-white">
                  Implementing Research and Studies with a focus on activating partnerships and providing training in information technology can bring about several benefits</p>
        ...
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 class="text-45 md:text-30 lh-12"> Start with the <span class="text-purple-1">Research and Studies</span></h3>
