            ...
            <div class="dashboard__content bg-light-4">
              <div class="row pb-50 mb-10">
                <div class="col-auto">
                  ...
                  <h1 class="text-30 lh-12 fw-700">Forums</h1>
              ...
              <div class="row y-gap-30">
                <div class="col-12">
                  <div class="rounded-16 bg-white shadow-4 h-100">
                    ...
                    <div class="py-30 px-30">
                      <h4 class="text-24 lh-12 fw-500">Course discussion</h4>
                      <div class="mt-15">In this space we'll discuss aspects of the films and of psychology in cinema in general. Feel free to raise issues which you think might help you with later assignments and group projects. This is a hive mind area! You can rate others and view ratings.</div>
                      <button class="button h-50 px-30 -purple-1 text-white mt-30">Add a New Discussion Topic</button>

                      <div class="mt-40">
                        <div class="px-30 py-20 bg-light-7 rounded-8">
                          <div class="row x-gap-10">
                            <div class="col-lg-4">
                              <div class="text-purple-1">Discussion</div>
                            </div>
                            <div class="col-lg-3">
                              <div class="text-purple-1">Started by</div>
                            </div>
                            <div class="col-lg-3">
                              <div class="text-purple-1">Last post</div>
                            </div>
                            <div class="col-lg-1">
                              <div class="text-purple-1">Replies</div>
                            </div>
                            <div class="col-lg-1">
                        ...
                        <div class="px-30 border-bottom-light">
                          <div class="row x-gap-10 items-center py-25">
                            <div class="col-lg-4">
                              <div class="text-purple-1">Depiction in foreign language films</div>
                            </div>
                            ...
                            <div class="col-lg-3">
                              <div class="d-flex items-center">
                                <img src="img/misc/2.png" alt="image" class="size-40 fit-cover">
                                <div class="ml-10">
                                  <div class="text-dark-1 lh-12 fw-500">Jeffrey Sanders</div>
                                  <div class="text-14 lh-12 mt-5">16 Feb 2017</div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="d-flex justify-between items-center mt-50">
                        ...
                        <div class="dropdown js-dropdown js-category-active">
                          <div class="dropdown__button d-flex items-center text-14 bg-white border-light rounded-8 px-20 py-10 " data-el-toggle=".js-category-toggle" data-el-toggle-active=".js-category-active">
                ...
                <div class="col-12">
                  <div class="rounded-16 bg-white shadow-4 h-100">
                    <div class="d-flex justify-between items-center py-20 px-30 border-bottom-light">
                      <h2 class="text-17 lh-1 fw-500">Course discussion The attraction of Mental Illness</h2>


                      <div class="dropdown js-dropdown js-category-active">
                        <div class="dropdown__button d-flex items-center text-14 bg-transparent " data-el-toggle=".js-category-toggle" data-el-toggle-active=".js-category-active">
                          <span class="js-dropdown-title">Settings</span>
                          <i class="icon text-9 ml-40 icon-chevron-down"></i>
                        </div>
                    ...
                    <div class="py-30 px-30">
                      <div class="d-flex items-center justify-between">
                        ...
                        <div class="dropdown js-dropdown js-category-active">
                          <div class="dropdown__button d-flex items-center text-14 bg-light-3 rounded-8 px-20 py-10 " data-el-toggle=".js-category-toggle" data-el-toggle-active=".js-category-active">
                            <span class="js-dropdown-title">Display Replies In Threaded From</span>
                            <i class="icon text-9 ml-40 icon-chevron-down"></i>
                          </div>
                          ...
                          <div class="d-flex ">
                            ...
                            <div class="comments__body md:mt-15">
                              <div class="comments__header">
                                ...
                                <div class="d-flex x-gap-5 items-center mt-10">
                              ...
                              <div class="comments__helpful mt-20">
                                <button class="button text-13 px-15 py-10 -light-7 text-purple-1">Respond</button>
                              </div>
                            </div>
