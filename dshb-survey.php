            ...
            <div class="dashboard__content bg-light-4">
              <div class="row pb-50 mb-10">
                <div class="col-auto">
                  ...
                  <h1 class="text-30 lh-12 fw-700">Survey</h1>
              ...
              <div class="row y-gap-30">
                <div class="col-12">
                  <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    ...
                    <div class="py-30 px-30">
                      <h4 class="text-24 lh-12 fw-500">Your views on this course</h4>
                      <div class="mt-15">Mode: User's name will be logged and shown with answers</div>

                      <div class="mt-50">
                        <div class="row y-gap-20">
                          <div class="col-lg-4">
                            <div class="text-dark-1">How do you rate this course?</div>
                          </div>
                          ...
                          <div class="col-auto">
                            ...
                            <div class="form-radio d-flex items-center ">
                              ...
                              <div class=" ml-12">Outstanding</div>
                            </div>
                            ...
                            <div class="form-radio d-flex items-center mt-10">
                              ...
                              <div class=" ml-12">Satisfactory</div>
                            </div>
                        ...
                        <div class="row y-gap-20 pt-40">
                          <div class="col-lg-4">
                            <div class="text-dark-1">In one word, how would you describe the course to other students?</div>
                          </div>
                        ...
                        <div class="row y-gap-20 pt-40">
                          <div class="col-lg-4">
                            <div class="text-dark-1">Did you use the mobile app?</div>
                          </div>
                      ...
                      <div class="d-flex x-gap-20 items-center pt-30">
                        <div><a href="#" class="button px-50 -dark-1 -dark-button-white h-50 text-white">Next Page</a></div>
                        <div><a href="#" class="button px-50 -outline-dark-1 h-50 text-dark-1">Cancel</a></div>
                      </div>
