              ...
              <div class="row y-gap-30 relative">
                <div class="col-xl-7 col-lg-8">
                  <div class="d-flex x-gap-15 y-gap-10 pb-20">
                    ...
                    <div>
                      <div class="badge px-15 py-8 text-11 bg-blue-1 text-white fw-400">POPULAR</div>
                    </div>
                  </div>
                  ...
                  <p class="col-xl-9 mt-20 text-white">Use XD to get a job in UI Design, User Interface, User Experience design, UX design & Web Design</p>

                  <div class="d-flex x-gap-30 y-gap-10 items-center flex-wrap pt-20">
                    <div class="d-flex items-center text-white">
                      <div class="text-14 lh-1 text-green-1 mr-10">4.5</div>
                      <div class="d-flex x-gap-10 items-center">
                        <div class="icon-star text-9 text-green-1"></div>
                        <div class="icon-star text-9 text-green-1"></div>
                        <div class="icon-star text-9 text-green-1"></div>
                        <div class="icon-star text-9 text-green-1"></div>
                        <div class="icon-star text-9 text-green-1"></div>
                  ...
                  <div class="d-flex items-center pt-20">
                    ...
                    <div class="text-14 lh-1 ml-10 text-white">Ali Tufan</div>
                  </div>
                </div>
              ...
              <div class="col-lg-8">
                <div class="page-nav-menu -line">
                  <div class="d-flex x-gap-30">
                    <div><a href="#overview" class="pb-12 page-nav-menu__link js-scroll-to-id is-active">Overview</a></div>
                    <div><a href="#course-content" class="pb-12 page-nav-menu__link js-scroll-to-id">Course Content</a></div>
                    <div><a href="#instructors" class="pb-12 page-nav-menu__link js-scroll-to-id">Instructors</a></div>
                    <div><a href="#reviews" class="pb-12 page-nav-menu__link js-scroll-to-id">Reviews</a></div>
                  </div>
                </div>
