            ...
            <div class="row justify-center text-center">
              <div class="col-auto">
                <div data-anim="slide-up delay-1">
                  ...
                  <h1 class="page-header__title">Consultation Services</h1>
      ...
      <section class="layout-pt-md layout-pb-md">
        <div data-anim-wrap class="container">
          <div class="row y-gap-50 justify-between items-center">
            ...
            <div class="col-lg-5">
              <h2 class="text-30 lh-16">Activating the partnerships</h2>
              <p class="text-dark-1 mt-30">between external parties and King Saud University represented by King Abdullah Institute for Research and Consulting Studies by providing consulting and training services in the latest fields of information technology to cover the needs and support the work of the beneficiaries.</p>
              <p class="pr-50 lg:pr-0 mt-25">•	Work to build new partnerships with various public and private entities to ensure the sustainability of providing training services and technical advice.</p>
          ...
          <div class="row y-gap-20 justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text ">Consultation Services</p>
          ...
          <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Identification of Needs and Objectives</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Activation of Partnerships</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Expansion of Partnerships for Sustainability</div>
              </div>
            </div>
            ...
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text text-white">
                  Implementing consultation services with a focus on activating partnerships and providing training in information technology can bring about several benefits</p>
        ...
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 class="text-45 md:text-30 lh-12"> Start with the <span class="text-purple-1">Consultation Services</span></h3>
