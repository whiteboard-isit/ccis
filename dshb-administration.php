            ...
            <div class="dashboard__content bg-light-4">
              <div class="row pb-50 mb-10">
                <div class="col-auto">
                  ...
                  <h1 class="text-30 lh-12 fw-700">Site Administration</h1>
                ...
                <div class="col-12">
                  <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs pt-0">
                      <div class="tabs__controls d-flex x-gap-30 flex-wrap items-center pt-20 px-20 border-bottom-light js-tabs-controls">
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button is-active" data-tab-target=".-tab-item-1" type="button">Site administration</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-2" type="button">Users</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-3" type="button">Courses</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-4" type="button">Grades</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-5" type="button">Plugins</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-6" type="button">Appearance</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-7" type="button">Server</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-8" type="button">Reports</button>
                        </div>
                        <div class="">
                          <button class="tabs__button text-light-1 js-tabs-button" data-tab-target=".-tab-item-9" type="button">Development</button>
                        </div>
                      </div>

                      <div class="tabs__content py-40 px-30 js-tabs-content">
                        <div class="tabs__pane -tab-item-1 is-active">
                          <div class="row y-gap-50 x-gap-50">

                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Analytics</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Competencies</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Badges</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              ...
                              <div class="mt-40">
                                <h4 class="text-18 lh-12 fw-500">Location</h4>
                                <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Language</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Messaging</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <h4 class="text-18 lh-12 fw-500">Security</h4>
                              <div class="d-flex y-gap-10 flex-column pt-15">
                            ...
                            <div class="w-1/5 xl:w-1/4 lg:w-1/3 md:w-1/2 sm:w-1/1">
                              <div>
                                <h4 class="text-18 lh-12 fw-500">Front page</h4>
                                <div class="d-flex y-gap-10 flex-column pt-15">
                              ...
                              <div class="mt-40">
                                <h4 class="text-18 lh-12 fw-500">Mobile app</h4>
                                <div class="d-flex y-gap-10 flex-column pt-15">
