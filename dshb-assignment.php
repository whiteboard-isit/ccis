            ...
            <div class="dashboard__content bg-light-4">
              <div class="row pb-50 mb-10">
                <div class="col-auto">
                  ...
                  <h1 class="text-30 lh-12 fw-700">Assignment</h1>
              ...
              <div class="row y-gap-30">
                <div class="col-xl-10">
                  <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    ...
                    <div class="py-30 px-30">
                      <div>
                        <h4 class="text-18 lh-1 fw-500">Assignment 1 (Text or Audio)</h4>
                        <div class="col-xl-6">
                          <p class="mt-15">Keep it short! Type or Record your answer! Record with the audio or video buttons above! From your readings, define Digital Literacy in no more than 15 words. Can you master the art of being succinct?</p>
                        </div>
                      </div>

                      <div class="mt-60">
                        <h4 class="text-18 lh-1 fw-500">Grading summary</h4>
                      </div>

                      <div class="mt-30">

                        <div class="rounded-8 px-25 py-25 bg-light-4">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Hidden from students</div>
                            </div>
                            <div class="col-auto">No</div>
                          </div>
                        </div>

                        <div class="rounded-8 px-25 py-25 ">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Participants</div>
                            </div>
                        ...
                        <div class="rounded-8 px-25 py-25 bg-light-4">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Submitted</div>
                            </div>
                        ...
                        <div class="rounded-8 px-25 py-25 ">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Needs grading</div>
                            </div>
                        ...
                        <div class="rounded-8 px-25 py-25 bg-light-4">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Due date</div>
                            </div>
                            <div class="col-auto">Thursday, 26 December 2019, 1:00 AM</div>
                          </div>
                        </div>
                        ...
                        <div class="rounded-8 px-25 py-25 ">
                          <div class="row">
                            <div class="col-3">
                              <div class="text-dark-1">Time remaining</div>
                            </div>
                            <div class="col-auto">Assignment is due</div>
                          </div>
                        </div>

                      </div>

                      <div class="d-flex x-gap-30 justify-center items-center mt-30">
                        <div>

                          <a href="" class="button -icon -light-3 h-50">
                      ...
                      <div class="d-flex justify-between items-center mt-40">
                        ...
                        <div class="dropdown js-dropdown js-category-active">
                          <div class="dropdown__button d-flex items-center text-14 bg-white -dark-bg-dark-1 border-light rounded-8 px-20 py-10 " data-el-toggle=".js-category-toggle" data-el-toggle-active=".js-category-active">
