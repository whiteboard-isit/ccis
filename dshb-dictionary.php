                  ...
                  <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                    ...
                    <div class="py-30 px-30">
                      <div class="row y-gap-15 justify-between items-center mb-30">
                        ...
                        <div class="col-auto">
                          <a href="#" class="button -md -purple-1 text-white">Add a New Entry</a>
                        </div>
                      </div>
                        ...
                        <div class="col-12">
                          <div class="d-flex x-gap-10 y-gap-10 flex-wrap">
                            ...
                            <div>
                              ...
                              <div class="size-35 d-flex justify-center items-center border-light rounded-4 bg-dark-1 -dark-bg-dark-2 text-white">
                                J
                              </div>
                      ...
                      <div class="border-light overflow-hidden rounded-8 mt-30">
                        <div class="py-20 px-30 bg-light-7 -dark-bg-dark-2">
                          <div class="d-flex justify-between">
                            <h4 class="text-24 lh-1 fw-700 text-purple-1">A</h4>
                          </div>
                        </div>
                        ...
                        <div class="px-30 py-25">
                          <div class="row y-gap-20 items-center justify-between">
                            <div class="col-auto">
                              <div class="text-dark-1 text-17 fw-500">Accessibility</div>
                              <div class="mt-8">The design of apps, devices, materials and environments that support and enable access to content and educational activities for all learners. </div>
                            </div>
                      ...
                      <div class="border-light overflow-hidden rounded-8 mt-30">
                        <div class="py-20 px-30 bg-light-7 -dark-bg-dark-2">
                          <div class="d-flex justify-between">
                            <h4 class="text-24 lh-1 fw-700 text-purple-1">B</h4>
                          </div>
                        </div>
                        ...
                        <div class="px-30 py-25">
                          <div class="row y-gap-20 items-center justify-between">
                            <div class="col-auto">
                              <div class="text-dark-1 text-17 fw-500">Blended learning</div>
                              <div class="mt-8">The design of apps, devices, materials and environments that support and enable access to content and educational activities for all learners. </div>
                            </div>
