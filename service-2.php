...
<head>
  ...
  <title>Projects and Technical Solutions</title>
</head>
            ...
            <div class="row justify-center text-center">
              <div class="col-auto">
                <div data-anim="slide-up delay-1">
                  ...
                  <h1 class="page-header__title">Projects and Technical Solutions</h1>
      ...
      <section class="layout-pt-md layout-pb-md">
        <div data-anim-wrap class="container">
          <div class="row y-gap-50 justify-between items-center">
            ...
            <div class="col-lg-5">
              <h2 class="text-30 lh-16">Provide projects and technical solutions </h2>
              <p class="text-dark-1 mt-30">implemented by work teams from the college faculty to achieve the requirements of the beneficiaries.</p>
              <p class="pr-50 lg:pr-0 mt-25">Participation in the formulation of beneficiaries’ technical offers when they submit requests for proposals, as well as participation in committees to study and arbitrate technical offers submitted to the beneficiaries.</p>
          ...
          <div class="row y-gap-20 justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text ">Projects and Technical Solutions</p>
          ...
          <div class="row y-gap-30 justify-between pt-60 lg:pt-40">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Assessment and Proposal Submission</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Committee Evaluation and Arbitration</div>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-6">
              <div class="d-flex flex-column items-center text-center">
                ...
                <div class="text-17 fw-500 text-dark-1 mt-30">Implementation of Selected Projects</div>
              </div>
            </div>
            ...
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text text-white">
                  Implementing Projects and Technical Solutions with a focus on activating partnerships and providing training in information technology can bring about several benefits</p>
        ...
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 class="text-45 md:text-30 lh-12"> Start with the <span class="text-purple-1">Projects and Technical Solutions</span></h3>
