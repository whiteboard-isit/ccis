            ...
            <div class="row y-gap-30 justify-between">
              <div class="col-xl-6 col-lg-6">
                ...
                <div data-anim="slide-up delay-1">
                  <h1 class="text-30 lh-14 text-white pr-60 lg:pr-0">User Experience Design Essentials - Adobe XD UI UX Design</h1>
                </div>

                <p class="text-dark-3 mt-20">Use XD to get a job in UI Design, User Interface, User Experience design, UX design & Web Design</p>
                ...
                <div class="mt-30">
                  ...
                  <div class="d-flex justify-between py-8 border-bottom-light-2">
                    ...
                    <div class="text-white">13 Hours</div>
                  </div>
                  ...
                  <div class="d-flex justify-between py-8 border-bottom-light-2">
                    ...
                    <div class="text-white">Beginner</div>
                  </div>
                ...
                <div class="d-flex mt-30">
                  ...
                  <a href="#" class="d-flex justify-center items-center size-40 rounded-full text-dark-3">
                    <i class="fa fa-facebook"></i>
                  </a>
              ...
              <div class="col-xl-5 col-lg-6">
                ...
                <div class="mt-30">
                  <div class="d-flex justify-between items-center">
                    <div class="text-24 lh-1 text-white fw-500">$96.00</div>
                    <div class="lh-1 line-through text-dark-3">$76.00</div>
                  </div>
                  ...
                  <div class="row x-gap-30 y-gap-20 pt-30">
                    ...
                    <div class="col-sm-6">
                      <button class="button -md -outline-green-1 text-green-1 w-1/1">Buy Now</button>
                    </div>
                  </div>

                  <div class="text-14 lh-1 text-dark-3 mt-30">30-Day Money-Back Guarantee</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row y-gap-40">
              <div class="col-lg-4">
                <div class="tabs__controls y-gap-5 js-tabs-controls">
                  ...
                  <div>
                    <button class="tabs__button text-18 fw-500 js-tabs-button " data-tab-target=".-tab-item-3" type="button">Instructors</button>
                  </div>

                  <div>
                    <button class="tabs__button text-18 fw-500 js-tabs-button " data-tab-target=".-tab-item-4" type="button">Review</button>
                  </div>
              ...
              <div class="col-lg-8">
                <div class="tabs__content js-tabs-content">
                  <div class="tabs__pane -tab-item-1 is-active">
                    ...
                    <div class="mt-60">
                      <h4 class="text-20 fw-500 mb-30">What you'll learn</h4>
                    ...
                    <div class="mt-60">
                      <h4 class="text-20 fw-500">Requirements</h4>
